        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="{{ asset('imageproduct/' . $products->img) }}" alt="Card image cap"
                            id="product-detail">
                    </div>
                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid"
                                                    src="{{ asset('imageproduct/' . $products->img) }}" alt="Card image cap"
                                                    id="product-detail">
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">{{ $products->prod_name }}</h1>
                            <p class="h3 py-2">${{ $products->prod_price }}</p>
                            <p class="py-2">
