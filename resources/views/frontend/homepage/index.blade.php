    ...
    <div id="template-mo-zay-hero-carousel" class="carousel slide" data-bs-ride="carousel">
        <ol class="carousel-indicators">
            @for ($i = 0; $i < count($slideshows); $i++)
                <li data-bs-target="#template-mo-zay-hero-carousel" data-bs-slide-to="{{ $i }}"
                    class="{{ $i == 0 ? 'active' : '' }}"></li>
            @endfor
        </ol>
                        ...
                        <div class="row p-5">
                            <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                                @if ($slideshow->id == null)
                                    <img class="img-fluid" src="/img/Image_not_available.png" alt="Image_not_available.png">
                                @endif
                                <img class="img-fluid" src="/imageslideshow/{{ $slideshow->img }}"
                                    alt="{{ $slideshow->img }}">
                            </div>
