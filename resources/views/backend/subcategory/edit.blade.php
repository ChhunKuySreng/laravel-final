                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $subcategory->sub_cat_name }}" name="sub_cat_name"
                                                id="sub_cat_name" type="text"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="cat_id" id="cat_id"
                                                ...
                                                <option selected="true" disabled="disabled">Select Category Name</option>
                                        ...
                                        <div class="form-group">
                                            <label for="cat_description" class="form-label">Sub Category Description
                                                (Optional)</label>
                                            <input value="{{ $subcategory->sub_cat_description }}" name="sub_cat_description"
                                                id="sub_cat_description" type="text"
